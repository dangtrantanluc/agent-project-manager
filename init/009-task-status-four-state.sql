-- Finalize task workflow to TODO, IN_PROGRESS, DONE, CANCELLED.
-- Legacy IN_REVIEW tasks are treated as DONE.
...
BEGIN
    ...
    IF labels IS DISTINCT FROM ARRAY['TODO', 'IN_PROGRESS', 'DONE', 'CANCELLED'] THEN
        ...
        ALTER TYPE public."TaskStatus" RENAME TO "TaskStatus_previous_four_state";
        ...
        DROP TYPE public."TaskStatus_previous_four_state";
    END IF;
END $$;
